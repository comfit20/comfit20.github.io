...
if __name__ == '__main__':
    exercises = ['Mountain Climber', 'Superman (alt: Pull Ups)', 'Windshield Wiper', '3 Frog Squats & 6 Plank Jumps',
                 'Squat & Knee Rise',
                 'Push Up & Squat & Turn', 'Heel Touch Crunches', 'Shoot Through', 'Jumping Lunges',
                 '10 Fast Feet & Push Up']
