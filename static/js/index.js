  ...
  var target = $(e.target).attr("href") // activated tab
   ...
   $('html').toggleClass('bg-yoga','bg-workout')
    ...
    function createWorkoutTimeList() {
        ...
        var time_3 = getNextWeekday(3).set('h',19).set('m',2).set('s',0).set('ms',0);
        ...
        var time_5 = getNextWeekday(5).set('h',19).set('m',2).set('s',0).set('ms',0);
...
function createYogaTimeList() {
    ...
    function renderWebsite() {
        ...
        var time_list = createWorkoutTimeList();
          ...
          time_Wed: getNextWeekday(3).set('h',19).set('m',2).set('s',0).set('ms',0),
          // time_Thu: getNextWeekday(4).set('h',17).set('m',2).set('s',0).set('ms',0),
          time_Fri: getNextWeekday(5).set('h',19).set('m',2).set('s',0).set('ms',0)
      }
