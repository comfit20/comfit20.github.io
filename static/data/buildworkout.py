...
exercises = ['2 Jumping Jack & 1 Tuck Jump','Flutter Kicks (Scissor)', 'Inch Worm', 'Rope Jump', 'Jumping Lunges','Butt Kicker', 
 'Shoot Through', 'Frog Squats', 'Sit Up', 'Low & High Plank Switch']
