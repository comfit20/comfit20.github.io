...
exercises = ['Ice Skater', 'Diamond Push Up', '2 Jumping Jack & 1 Tuck Jump', 'Push Up & Side Turn', 'Wall Sit (alt: Squat)', 
'Flutter Kicks (Scissor)', 'Fast Squats', 'Russian Twist', 'High Plank Shoulder Tap', 'Crunches', 'Side Hops', 'Swimmer']
...
# Code for upload to jsonbin --> Group workout always takes latest uploaded version automatically :)
DO_UPLOAD = True
if DO_UPLOAD:
    import requests
    url = 'https://api.jsonbin.io/b/5ec4a5ad18c8475bf16c9fcb'
    headers = {'Content-Type': 'application/json',
               'secret-key': '$2b$10$/ldSxL8e6TFRK4PEwQ8lMOCN501mvWVBeVQ78d1ULQHEakRFuS9By'}
    data = workout
    req = requests.put(url, json=data, headers=headers)
    sucess = json.loads(req.text)["success"]
    if sucess:
