...
exercises = ['Prayer Pulse', '6 Fast Feet In & Out', 'Push Up', 'Jump Squat (+ Touch)', 'Single-Leg Glute Bridge',
 'Single Leg Donkey Kick', 'Flutter Kicks (Scissor)', 'Diamond Push Up', 'Side Plank Crunches', 'Swimmer', 'Inch Worm', 
 'Wall Sit (alt: Squat)' ]
