...
exercises = ['Jump Squat (+ Touch)', '10 High Knee & 3 Tuck Jumps', 'Superman (alt: Pull Ups)', 
'Frog Squats', 'Crunches', 'Bird Dog', 'Single Leg Donkey Kick', 'Heel Touch Crunches', 'Low & High Plank Switch']
